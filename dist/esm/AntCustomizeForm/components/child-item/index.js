...
var ChildItem = function ChildItem(props) {
  ...
  var childProps = _objectSpread(
    _objectSpread(_objectSpread({}, props), typeProps),
    {},
    {
  ...
  switch (type) {
    ...
    case ItemTypes.DATEPICKER:
      return /*#__PURE__*/ _jsxs(Space, {
        ...
        children: [
          ...
          /*#__PURE__*/ _jsx(DatePicker, _objectSpread({}, childProps)),
          /*#__PURE__*/ _jsx('span', {
            children: typeProps === null || typeProps === void 0 ? void 0 : typeProps.lastText,
          }),
        ],
    ...
    case ItemTypes.TIMEPICKER:
      return /*#__PURE__*/ _jsxs(Space, {
        ...
        children: [
          ...
          /*#__PURE__*/ _jsx(TimePicker, _objectSpread({}, childProps)),
          /*#__PURE__*/ _jsx('span', {
            children: typeProps === null || typeProps === void 0 ? void 0 : typeProps.lastText,
          }),
        ],
    ...
    case ItemTypes.RANGEPICKER:
      return /*#__PURE__*/ _jsxs(Space, {
        ...
        children: [
          ...
          /*#__PURE__*/ _jsx(DatePicker.RangePicker, _objectSpread({}, childProps)),
          /*#__PURE__*/ _jsx('span', {
            children: typeProps === null || typeProps === void 0 ? void 0 : typeProps.lastText,
          }),
        ],
    ...
    case ItemTypes.BUTTON:
      return /*#__PURE__*/ _jsxs(Space, {
        style: typeProps === null || typeProps === void 0 ? void 0 : typeProps.style,
        className:
          typeProps !== null && typeProps !== void 0 && typeProps.style ? '' : styles.btnStyles,
        children: [
          /*#__PURE__*/ _jsx(Button, {
            type: 'primary',
            htmlType: 'submit',
            children:
              (typeProps === null || typeProps === void 0 ? void 0 : typeProps.btnText) || '查询',
          }),
          /*#__PURE__*/ _jsx(Button, {
            htmlType: 'submit',
            onClick: function onClick() {
              ...
              context === null || context === void 0
                ? void 0
                : (_context$formProps = context.formProps) === null || _context$formProps === void 0
                ? void 0
                : (_context$formProps$fo = _context$formProps.form) === null ||
                  _context$formProps$fo === void 0
                ? void 0
                : _context$formProps$fo.resetFields();
              setTimeout(function () {
                renderOptions();
              }, 1000);
            },
          ...
          (typeProps === null || typeProps === void 0 ? void 0 : typeProps.linkBtnText) &&
            /*#__PURE__*/ _jsx(
              Button,
              _objectSpread(
                _objectSpread(
    ...
    case ItemTypes.CUSTOMIZE:
      return /*#__PURE__*/ _jsxs(WFC.Provider, {
        ...
        children: [
          ' ',
          ((itemProps === null || itemProps === void 0 ? void 0 : itemProps.name) &&
            (customize === null || customize === void 0
              ? void 0
              : customize[itemProps === null || itemProps === void 0 ? void 0 : itemProps.name])) ||
            '未配置自定义组件',
        ],
      });
    //自定义组件获取formitem的值
